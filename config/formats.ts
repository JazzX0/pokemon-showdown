...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	///////////////////////////////////////////////////////////////////
    {
		section: "Meteora Formats",
		column: 1,
	},
	{
		name: "[Gen 3] Ubers (Meteora)",
		mod: 'meteora',
		gen: 9,
		searchShow: true,
		challengeShow: true,
		ruleset: ['[Gen 3] OU', 'Deoxys Camouflage Clause', 'One Baton Pass Clause','!Team Preview'],
  ...
  // Gen 3
  'Cascoon',
  // We Hate Cascoon in this house.. apparently, I (jazz) think its awesome also it makes more sense to yeet Silcoon rather
  // than Cascoon cause Beautifly is now Dark type and Edgy
  // Gen 4 (excluding Budew, Roserade)
  ...
  'Chewtle','Drednaw','Yamper','Boltund','Rolycoly','Carkol',
  'Coalossal','Applin','Flapple','Appletun','Silicobra','Sandaconda',
  'Cramorant','Arrokuda','Barraskewda','Toxel','Toxtricity','Sizzlipede',
  ...
  'Arboliva','Squawkabilly','Nacli','Naclstack','Garganacl',
  'Charcadet','Armarouge','Ceruledge','Tadbulb','Bellibolt',
  'Wattrel','Kilowattrel','Maschiff','Mabosstiff','Shroodle',
  'Grafaiai','Bramblin','Brambleghast','Toedscool','Toedscruel',
  'Klawf','Capsakid','Scovillain','Rellor','Rabsca','Flittle',
  'Espathra','Tinkatink','Tinkatuff','Tinkaton','Wiglett','Wugtrio',
  'Bombirdier','Finizen','Palafin','Varoom','Revavroom','Cyclizar',
  'Orthworm','Glimmet','Glimmora','Greavard','Houndstone','Flamigo',
  'Cetoddle','Cetitan','Veluza','Dondozo','Tatsugiri','Annihilape',
  'Clodsire','Farigiraf','Dudunsparce','Kingambit','Great Tusk',
